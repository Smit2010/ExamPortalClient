                        ...
                        <div className="control" >
                            <label className="radio is-flex" >
                                <div style={{display: "flex", alignItems: "center", marginLeft: "20px"}}>
                                    {
                                        this.props.past ? (
                                            <input type="radio" id={elem.id} name={this.props.id} style={{margin: "0 10px"}} disabled checked={this.props.answer.includes(elem.id)}/>
                                        ) : (
                                            <input type="radio" id={elem.id} name={this.props.id} style={{margin: "0 10px"}}/>
                                        )
                                    }
                                </div>
                                <div dangerouslySetInnerHTML={this.show(elem.output)}></div>
