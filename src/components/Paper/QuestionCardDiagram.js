            ...
            this.props.show ? ( <div className="box question is-flex" style={{marginTop: "20px", justifyContent: "space-between"}}>
                ...
                <div style={{flexDirection: "column", marginLeft: "30px", width: "100%"}}>
                    <div className="is-flex" style={{width: "100%"}}>
                        ...
                        {this.props.past ? this.findStatus() : ""}
                    </div>
                    <div>
                            ...
                            <div className="control" >
                                <label className="radio is-flex" >
                                    <div style={{display: "flex", alignItems: "center", marginLeft: "20px"}}>
                                        {
                                            this.props.past ? (
                                                <input type="radio" id={elem.id} name={this.props.id} style={{margin: "0 10px"}} disabled checked={this.props.studentAnswer.includes(elem.id)}/>
                                            ) : (
                                                <input type="radio" id={elem.id} name={this.props.id} style={{margin: "0 10px"}} onChange={this.handleChange}/>
                                            )
                                        }
                                    </div>
                                    <div dangerouslySetInnerHTML={this.show(elem.output)}></div>
                        ...
                        this.props.past ? (
                            <div>
                                ...
                                <div style={{marginLeft: "20px", marginTop: "10px"}}>
                                    {this.props.optionList.filter(option => this.props.correctAnswer.includes(option.id))
                                    .map(option => 
                                        <div className="is-flex" style={{alignItems: "center"}}>
                                            <ArrowForwardIcon />
                                            <div dangerouslySetInnerHTML={this.show(option.output)}></div>
                                        </div>
                                    )}
                                </div>
                            </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(QuestionCardDiagram))
