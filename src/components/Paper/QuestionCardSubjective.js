...
class QuestionCardSubjective extends Component {
    ...
    handleChange = (e) => {
        ...
        this.props.handleAddAnswer(this.props.id, [e.target.value])
    }
        ...
        return (
            this.props.show ? ( <div className="box question is-flex" style={{marginTop: "20px", justifyContent: "space-between"}}>
                ...
                <div style={{flexDirection: "column", width: "100%", marginLeft: "30px"}}>
                    ...
                    <div className="is-flex" style={{margin: "0px 20px"}}>
                        {
                            this.props.past ? (
                                <div className="is-flex" style={{flexDirection: "column"}}>
                                    ...
                                    <div className="is-flex" style={{alignItems: "center"}}>
                                        <ArrowForwardIcon />
                                        <p style={{fontSize:"20px", marginBottom: "10px"}} dangerouslySetInnerHTML={this.show(this.props.studentAnswer[0])}></p>
                                    </div>
                                    <p className="subtitle" style={{marginBottom: "0px"}}>Correct Answer : </p>
                                    <div className="is-flex" style={{alignItems: "center"}}>
                                        <ArrowForwardIcon />
                                        <p style={{fontSize:"20px", marginBottom: "10px"}} dangerouslySetInnerHTML={this.show(this.props.correctAnswer[0])}></p>
                                    </div>
                                </div>
                            ) : (
