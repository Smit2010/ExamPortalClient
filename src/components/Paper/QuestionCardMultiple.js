                                ...
                                <label className="checkbox is-flex" >
                                    {
                                        this.props.user.type === "faculty" ? (
                                            <div style={{display: "flex", alignItems: "center"}}><input type="checkbox" id={option.id} name={this.props.id} checked={this.props.correctAnswer.filter(answer => answer.text === option.id).length} disabled style={{margin: "0 10px"}}/></div>
                                        ) : (
                                            <div style={{display: "flex", alignItems: "center"}}><input type="checkbox" id={option.id} name={this.props.id} checked={this.props.studentAnswer.filter(answer => answer.text === option.id).length} disabled style={{margin: "0 10px"}}/></div>
                                        )
                                    }
                            ...
                            <div className="control" >
                                <label className="checkbox is-flex" >
                                    <div style={{display: "flex", alignItems: "center", marginLeft: "20px"}}>
                                        <input type="checkbox" id={option.id} name={this.props.id} style={{margin: "0 10px"}} onChange={this.handleChange}/>
                                    </div>
                                    <div dangerouslySetInnerHTML={this.show(option.optionText)}></div>
                                </label>
                            </div>)
