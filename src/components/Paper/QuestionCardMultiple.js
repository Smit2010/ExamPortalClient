                            ...
                            <div className="control" >
                                <label className="checkbox is-flex" >
                                    <div style={{display: "flex", alignItems: "center", marginLeft: "20px"}}>
                                        {
                                            this.props.past ? (
                                                <input type="checkbox" id={elem.id} name={this.props.id} style={{margin: "0 10px"}} disabled checked={this.props.studentAnswer.includes(elem.id)}/>
                                            ) : (
                                                <input type="checkbox" id={elem.id} name={this.props.id} style={{margin: "0 10px"}} onChange={this.handleChange}/>
                                            )
                                        }
                                    </div>
                                    <div dangerouslySetInnerHTML={this.show(elem.output)}></div>
